        ...
        item.click(function () {
            ...
            if (jQuery('.dark-wrapper.fixed').length == 0) {
                ...
                jQuery('body').append('<div class="navcoverpage light-wrapper"></div>' +
                    ...
                    '<a href="#" id="gwi-thumbs" class="btn pull-left back">Закрыть</a>' +
                    // '<a href="#" id="gwi-next" class="btn pull-right rm0 nav-next-item">Далее</a>' +
                    // '<a href="#" id="gwi-prev" class="btn pull-right rm5 nav-prev-item">Назад</a>' +
                    '</div>' +
                    '<div class="clear"></div>' +
                    '</div>' +
                    '</div>' +
