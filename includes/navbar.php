      ...
      <div class="container">
        ...
        <nav class="collapse navbar-collapse pull-right">
          <ul class="nav navbar-nav">
            ...
            <li><a href="../pages/3">Официальное заявление о переходе на ЭЦД</a></li>
            <li><a href="../pages/1">Инструкция по работе на IDocs.kz</a></li>
...
<label for="menu-toggle" class="menu-icon">
  ...
  <img src="/img/menu.png" alt="4920 утилизация отходов">
</label>
